...
import StarredDetailView from "./DetailView";
import StarredTableView from "./TableView";

import ViewToggle from "../ViewToggle";

export default function StarredMainPage() {
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="mt-6 grid grid-cols-1 lg:grid-cols-[220px_1fr] gap-6">
            ...
            <div>
              ...
              {view === "grid" ? <StarredDetailView /> : <StarredTableView />}
            </div>
          </div>
        </div>
      </div>
