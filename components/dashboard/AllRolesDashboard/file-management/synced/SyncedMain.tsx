...
import SyncedDetailView from "./DetailView";
import SyncedTableView from "./TableView";


import ViewToggle from "../ViewToggle";

export default function SyncedMain() {
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="mt-6 grid grid-cols-1 lg:grid-cols-[220px_1fr] gap-6">
            ...
            <div>
              ...
              {view === "grid" ? <SyncedTableView /> : <SyncedDetailView />}
            </div>
          </div>
        </div>
      </div>
