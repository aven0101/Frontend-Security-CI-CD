...
export default function TechnicalCardSlider({ cardData }) {
          ...
          {cardData.map((card) => (
            ...
            >
              ...
              >
                ...
                {/* Divider */}
                <hr className="border-t border-[#43E1A9] my-3" />
                {/* Content */}
                <p className="text-[14px] min-h-[72px] text-[#43E1A9] font-semibold font-aptos leading-[120%]">
                  {card.content}
                </p>
