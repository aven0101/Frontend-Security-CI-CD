...
export default function SuperAdminDashboardHeader() {
    ...
    const navLinks = [
        { name: 'Manage Admins', href: '/business/manage-admins' },
        { name: 'Billing Info', href: '/business/billing-info' },
        { name: 'Security', href: '/business/security' },
    ];
                ...
                <div className='relative' id="avatar-dropdown">
                    ...
                    {dropdownOpen && (
                        <div onClick={() => setDropdownOpen(false)} className='absolute right-0 mt-2 w-48 bg-white rounded-2xl overflow-hidden shadow-lg z-50'>
                            <Link href="/business/profile-settings" className={`block px-4 py-2 ${pathname === "/business/profile-settings"
                                ? 'bg-[#98C1A9] text-white'
